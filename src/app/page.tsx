      ...
      <div className="flex flex-1">
        <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className='space-y-5 mt-8'>
            <a href="" className="flex itens-center gap-3 text-sm font-semibold text-zinc-300">
              <HomeIcon />
              Home
            </a>
            <a href="" className="flex itens-center gap-3 text-sm font-semibold text-zinc-300">
          ...
          <nav className='mt-7 pt-7 border-t border-zinc-800 flex flex-col gap-3'>
            <a href="" className='text-sm text-zinc-400 hover:text-zinc-100'>Hot Hits Brasil</a>
            <a href="" className='text-sm text-zinc-400 hover:text-zinc-100'>Funk 2024</a>
            ...
            <a href="" className='text-sm text-zinc-400 hover:text-zinc-100'>Coding and Music</a>
          </nav>
        </aside>
